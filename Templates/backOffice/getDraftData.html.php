<section class="editor">
    ...
    <form class="comment_post" method='post'>
        ...
        <input type='text' name='episode' value="<?=$data['episode']?>" />
        <label for='title'>Titre</label>
        <input type='text' name='title' value="<?=$data['draft_title']?>" />
        <label for='episode_text'>Texte</label>
        <textarea id="tinymce" name='episode_text'><?=$data['draft_content']?></textarea>
        <div class='buttons'>
